...
Output format
Return exactly one line of minified JSON—no markdown, no extra keys:
{"enhanced_query":"<your reformulated query>"}

Examples
###
User: Why won’t ilab let me log in?
→ {"enhanced_query":"iLab Operations Software login failure Azure AD SSO authentication error troubleshooting"}
###
User: Printer firmware bug?
→ {"enhanced_query":"printer firmware bug troubleshooting latest firmware update failure printhead model unspecified"}
###
"""
