...
class OpenAIService:
    ...
    def get_chat_response(self, messages, temperature=0.3, max_tokens=1000, top_p=1.0, presence_penalty=0.0, frequency_penalty=0.0):
        """
        ...
        logger.debug(f"Using temperature: {temperature}, max_tokens: {max_tokens}, top_p: {top_p}")
